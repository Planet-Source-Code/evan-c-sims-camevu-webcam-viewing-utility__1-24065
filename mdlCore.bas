...
'****************************************************************
'Windows API/Global Declarations for :SendMessage
'****************************************************************
...
'***************************************************************
'Windows API/Global Declarations for :Play AVI from Resource
'***************************************************************
' Uses SendMessage()
Public Const ACM_OPEN  As Long = &H464

Public Declare Function BitBlt Lib "GDI32" (ByVal hDestDC As _
Integer, ByVal x As Integer, ByVal y As Integer, ByVal nWid As _
Integer, ByVal nHt As Integer, ByVal hSrcDC As Integer, ByVal _
XSrc As Integer, ByVal YSrc As Integer, ByVal dwRop As Long) As Integer
Public Function ApplyBaseObjectRGB2(objLabel As Label, strRGB1 As String, strRGB2 As String, strRGB3 As String)

If strRGB1 > "" And strRGB2 > "" And strRGB3 > "" Then
   objLabel.ForeColor = RGB(strRGB1, strRGB2, strRGB3)
End If
